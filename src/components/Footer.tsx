...
const DEFAULT_BIO =
  "You'll probably find me building something — backend systems, developer tools, the occasional real-time pipeline — always chasing performance and clean design. Outside of that, I'm learning, experimenting, and exploring new ideas. For anything work-related, the Contact section is your best bet.";
